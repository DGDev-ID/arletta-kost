...
import { BedDouble, Building, FolderTree, LayoutGrid, Shield, Tag, Users, Wallet, FileSignature, HandCoins, Receipt, LogOut } from 'lucide-vue-next';
...
const transactionNavItems: NavItem[] = [
    {
        title: 'Bill Approval',
        href: '/transactions/bill-approval',
        icon: Receipt,
    },
    {
